...
public class Confirm {
	...
	private static String[] assertVerify(String description, Object actual, Object expected, String requirements, Boolean take_image, String check_type){
		/*
	...
	// Verify Methods
	public static void verify(String description, Object actual, Object expected, String requirements, Boolean take_image){
		assertVerify(description, actual, expected, requirements, take_image, "VERIFY");
	}
	
	public static void verify(String description, Object actual, Object expected, String requirements){
		verify(description, actual, expected, requirements, true);
	}
	
	public static void verify(String description, Object actual, Object expected){
		verify(description, actual, expected, "", true);
	}
	
	// Assert Methods
	public static void assertCheck(String description, Object actual, Object expected, String requirements, Boolean take_image){
		String[] results = assertVerify(description, actual, expected, requirements, take_image, "ASSERT");
	...
	public static void assertCheck(String description, Object actual, Object expected, String requirements){
		assertCheck(description, actual, expected, requirements, true);
	}
	
	public static void assertCheck(String description, Object actual, Object expected){
		assertCheck(description, actual, expected, "", true);
	}
}
